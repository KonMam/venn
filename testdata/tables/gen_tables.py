...
def appended(start=N + 50, count=25) -> pa.Table:
    out = []
...
def write_iceberg():
    ...
    # two pure appends: earlier snapshots' files stay live in later ones,
    # so snapshot-pair diffs have >1 shared file to prune
    tbl.append(appended())
    tbl.append(appended(N + 75, 10))
