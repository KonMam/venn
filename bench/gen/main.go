...
func main() {
	...
	pctTolerable := flag.Float64("tolerable", 0, "fraction of rows differing only within fixture.ToleranceAbs")
	...
	fmt.Printf("gen: %s rows_left=%d rows_right=%d added=%d removed=%d changed=%d tolerable=%d\n",
		*out, man.RowsLeft, man.RowsRight, man.Added, man.Removed, man.Changed, man.Tolerable)
}
