...
produces the public BENCHMARKS.md chart. This suite tracks tdiff against
itself.)
...
binary: build a well-formed file, break it *outside* tdiff, and verify tdiff
...
`TDIFF_TORTURE_ROUNDS=25`. Every subtest is named `mutator/seedN` — a failure
