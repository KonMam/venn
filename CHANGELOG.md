...
- `pkg/venn` and the GitHub Action expose all of the above; the fixture
...
- `pkg/venn` is a real public API: self-contained types, no internal
  leakage; module path is now `github.com/KonMam/venn`.
